...
function ingresar()
{
    ...
    fecha_nac='" . $_POST['fechanacimiento'] . "',direccion = '".$_POST['direccion']."',email='" . $_POST['correo'] . "',sexo='" . $_POST['sexo'] . "',
    telefono='" . $_POST['telefono'] . "',estado= 1 ,id_tipo_usuario= 3, pass='" . md5($_POST['pass']) . "'";
    
    mysqli_query(conexion(), $sql);

    $sql2="SELECT max(Id) as id2 FROM usuario";
