      ...
      ?>
        ...
        <span class="fs-4">Podología Marticorena</span>
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="administrarpacientes.php" class="nav-link text-white">
                <svg class="bi me-2" width="16" height="16">
        ...
        <br>
          ...
          <div id="formulario_usuario">
            <div class="container p-3 my-1 border">
              <h4> Paciente:</h4>
              <form action="adminpacientes.php" method="post" name="form1" enctype="multipart/form-data">
                <div class="row g-3">
                  <div class="col">
                ...
                <div class="row g-3">
                  <div class="col">
                    <input type="text" class="form-control" id="name" name="name" aria-label="Nombres" placeholder="Nombres" value="<?php echo $datosusu['nombre'] ?>">
                  </div>
                  <div class="col">
                    <input type="text" class="form-control" id="app" name="app" aria-label="Apellidos" placeholder="Apellidos" value="<?php echo $datosusu['apellido'] ?>">
                  </div>
                </div>
                <br>
                <div class="row g-3">
                  <div class="col">
                    <input type="text" class="form-control" id="direccion" name="direccion" aria-label="Direccion" placeholder="Direccion" value="<?php echo $datosusu['direccion'] ?>">
                  </div>
                </div>
                <br>
                <div class="row g-3">
                  <div class="col">
                    <input type="date" class="form-control" id="fechanacimiento" name="fechanacimiento" aria-label="Fecha Nacimiento" onclick="verfecha(this.value)" placeholder="Fecha Nacimiento" value="<?php echo $datosusu['fecha_nac'] ?>">
                  </div>
                  <?php
                ...
                <div class="row g-3">
                  ...
                  <label for="imagen[]">Inserte Imagen de Perfil:</label>
                    ...
                    <div class="col">
                    <label for="frmestado">Estado Paciente :</label>
